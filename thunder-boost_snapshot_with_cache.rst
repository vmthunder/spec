...
===========================================================================
Local snapshot for reducing data transfer when multiple homogeneous VMs are
booted on the same host
===========================================================================
...
waste of both bandwidth and time. To address this problem, we propose to realize
cinder-based, compute-side local snapshot (called VMT-snapshot). By this means
the boot-up data needs to be transferred only once for each host.
...
list. End users can choose "boot from VMT-snapshot" in the drop-down list in the
dashboard and enter the number of VMs to boot up.
